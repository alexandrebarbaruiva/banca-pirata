...
void LetterState::Update(float dt)
{
    ...
    if (sprites.size() <= 1)
    {
        ...
        std::string linha1 = "Sua mãe me disse que você estava atrás de um bico pra ganhar uma graninha ";
        std::string linha2 = "extra, e olha só que sorte a sua, acabou de abrir uma vaga com o seu nome ";
        std::string linha3 = "na banquinha do seu tio! E não tem momento melhor pra isso, porque o tio";
        ...
        std::string linha6 = "você precisa juntar R$250,00 até o fim do mês pra esse meu amigo,";
        ...
        std::string textocartaFinal1 = "PS: é muito importante que voce consiga esse dinheiro, ouviu?";
        std::string textocartaFinal2 = "Se não conseguir, feche a banca e não volte mais.";

        GameObject *textoCartaGO1 = new GameObject();
        textoCartaGO1->AddComponent(new Text(*textoCartaGO1, FONTS_PATH + "Karma Suture.otf", 40, Text::BLENDED, "Fala, garoto!", {0, 0, 0, SDL_ALPHA_OPAQUE}));
        textoCartaGO1->box.SetOrigin(610, 130);
        AddObject(textoCartaGO1);
        // GameObject *textoCartaGO2 = new GameObject();
        // textoCartaGO2->AddComponent(new Text(*textoCartaGO2, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, textocarta, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        // textoCartaGO2->box.SetOrigin(610,210);
        // AddObject(textoCartaGO2);

        GameObject *linha1CartaGO = new GameObject();
        linha1CartaGO->AddComponent(new Text(*linha1CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha1, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha1CartaGO->box.SetOrigin(610, 210);
        AddObject(linha1CartaGO);

        GameObject *linha2CartaGO = new GameObject();
        linha2CartaGO->AddComponent(new Text(*linha2CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha2, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha2CartaGO->box.SetOrigin(610, 270);
        AddObject(linha2CartaGO);

        GameObject *linha3CartaGO = new GameObject();
        linha3CartaGO->AddComponent(new Text(*linha3CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha3, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha3CartaGO->box.SetOrigin(610, 330);
        AddObject(linha3CartaGO);

        GameObject *linha4CartaGO = new GameObject();
        linha4CartaGO->AddComponent(new Text(*linha4CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha4, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha4CartaGO->box.SetOrigin(610, 390);
        AddObject(linha4CartaGO);

        GameObject *linha5CartaGO = new GameObject();
        linha5CartaGO->AddComponent(new Text(*linha5CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha5, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha5CartaGO->box.SetOrigin(610, 450);
        AddObject(linha5CartaGO);

        GameObject *linha6CartaGO = new GameObject();
        linha6CartaGO->AddComponent(new Text(*linha6CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha6, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha6CartaGO->box.SetOrigin(610, 510);
        AddObject(linha6CartaGO);

        GameObject *linha7CartaGO = new GameObject();
        linha7CartaGO->AddComponent(new Text(*linha7CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha7, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha7CartaGO->box.SetOrigin(610, 570);
        AddObject(linha7CartaGO);

        GameObject *linha8CartaGO = new GameObject();
        linha8CartaGO->AddComponent(new Text(*linha8CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha8, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha8CartaGO->box.SetOrigin(610, 630);
        AddObject(linha8CartaGO);

        GameObject *linha9CartaGO = new GameObject();
        linha9CartaGO->AddComponent(new Text(*linha9CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha9, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        linha9CartaGO->box.SetOrigin(610, 690);
        AddObject(linha9CartaGO);

        GameObject *linha10CartaGO = new GameObject();
        linha10CartaGO->AddComponent(new Text(*linha10CartaGO, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, linha10, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        ...
        textoCartaGO4->AddComponent(new Text(*textoCartaGO4, FONTS_PATH + "Karma Suture.otf", 30, Text::BLENDED, textocarta4, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        textoCartaGO4->box.SetOrigin(610, 860);
        AddObject(textoCartaGO4);

        GameObject *textoCartaGO5 = new GameObject();
        textoCartaGO5->AddComponent(new Text(*textoCartaGO5, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, textocartaFinal1, {0, 0, 0, SDL_ALPHA_OPAQUE}));
        textoCartaGO5->box.SetOrigin(610, 930);
        AddObject(textoCartaGO5);

        GameObject *textoCartaGO6 = new GameObject();
        textoCartaGO6->AddComponent(new Text(*textoCartaGO6, FONTS_PATH + "Karma Suture.otf", 20, Text::BLENDED, textocartaFinal2, {0, 0, 0, SDL_ALPHA_OPAQUE}));
